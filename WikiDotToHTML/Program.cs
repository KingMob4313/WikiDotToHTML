...
namespace WikiDotToHTML
{
    class Program
    {
        ...
        //static readonly string GuylianTag = "Guylian:  ##208020| ";
        ...
        static readonly string StTag = "YaraST:  ##666666| ";
        static readonly string YaraTag = "YaraSherred:  ##666666| ";
        static readonly string KaiTag = "Kai_Tukov:  ##110481| ";
        static readonly string GuylianTag = "Guylian:  ##208020| ";
        //static readonly string DamianTag = "DamianStark:\t##208020|";
        ...
        private static string ProcessLine(string line)
        {
            ...
            else
            {
                ...
                line = line.Replace(StTag, "<p style='color:#666666;'><span style='font-weight: bold; color:#000000;'>YaraST:\t</span>");
                ...
                line = line.Replace(GuylianTag, "<p style='color:#208020;'><span style='font-weight: bold; color:#000000;'>Guylian:\t</span>");
